...
namespace Service
{
    public class DocumentParserService : IDocumentParserService
    {
        ...
        public async Task<ParsedDocumentResult> ParseDocumentAsync(string filePath)
        {
        ...
        private async Task ParsePdfAsync(string filePath, ParsedDocumentResult result)
        {
        ...
        private void ExtractCvSections(ParsedDocumentResult result)
        {
            ...
            var sectionPatterns = new Dictionary<string, string[]>
            {
                ...
                ["Skills"] = new[] { "skills", "technical skills", "competencies" },
